...
from basicsr.data.data_util import paired_paths_from_folder, paired_paths_from_lmdb, paired_paths_from_meta_info_file,Get_lr_hr_images_from_namelist
...
class PairedImageDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        if opt['Us_RAM'] == True:
            ...
            self.lrs,self.hrs = Get_lr_hr_images_from_namelist(self.paths,self.file_client,self.io_backend_opt.pop('type'),self.io_backend_opt)

        self.Use_RAM = opt['Us_RAM'] 
    ...
    def __getitem__(self, index):
        ...
        if self.task == 'CAR':
            ...
            if self.Use_RAM == False:
                ...
                gt_path = self.paths[index]['gt_path']
                lq_path = self.paths[index]['lq_path']
                img_lq = self.lrs[index]
                img_gt = self.hrs[index]
